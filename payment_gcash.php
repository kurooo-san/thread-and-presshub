        ...
        <div class="col-md-6">
            ...
            <div class="card" style="border: 1px solid var(--border-light); border-radius: var(--radius-md);">
                <div class="card-body p-4">
                    <h5 class="mb-4 text-center" style="font-weight: 700;"><i class="fab fa-cc-stripe" style="margin-right: 0.5rem;"></i> GCash Payment</h5>
                    <div class="mb-4" style="background: var(--bg-light); border-radius: var(--radius-sm); padding: 1rem;">
                        ...
                        <p class="mb-0">
                            <strong>GCash Account:</strong> <span style="font-weight: 700;">0917-123-4567</span><br>
                            <strong>Amount:</strong> <span style="font-weight: 700;">₱<?php echo number_format($order['total'], 2); ?></span>
                        </p>
                    </div>

                    <ol class="mb-4">
                        <li class="mb-2">Open your GCash app or USSD *143#</li>
                        <li class="mb-2">Select Send Money</li>
                        <li class="mb-2">Enter the GCash number: <strong>0917-123-4567</strong></li>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" name="reference_number" placeholder="e.g., G123456789AB" required>
                            <small class="text-muted">You can find this in your GCash app under Transaction History</small>
                        </div>
