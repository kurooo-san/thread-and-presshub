    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-5">
                    <div class="card border-0" style="background: var(--bg-light); border-radius: 16px;">
                        <div class="card-body p-4 text-center">
                            <div class="mb-3"><i class="fas fa-wheelchair" style="font-size: 2.5rem; color: var(--primary);"></i></div>
                            <h5 style="font-weight:700;">PWD Discount</h5>
                            <p class="mb-2" style="font-size:2rem; font-weight:800; color: var(--primary);">20% OFF</p>
                            <p class="text-muted small">Valid PWD ID required at checkout</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="card border-0" style="background: var(--bg-light); border-radius: 16px;">
                        <div class="card-body p-4 text-center">
                            <div class="mb-3"><i class="fas fa-users" style="font-size: 2.5rem; color: var(--primary);"></i></div>
                            <h5 style="font-weight:700;">Senior Citizen Discount</h5>
                            <p class="mb-2" style="font-size:2rem; font-weight:800; color: var(--primary);">20% OFF</p>
                            <p class="text-muted small">Valid Senior Citizen ID required at checkout</p>
                        </div>
                    </div>
                </div>
            </div>
